...
//   - withRoleCompatibilityApplied: after Anthropic Messages is selected as
//     the final target, preserves inline system turns only where Anthropic's
//     state machine can express them. The mid-conversation-system flag forces
//     every inline system message to user for targets that do not support the
//     role at all.
//
