...
const pushText = (content: OpenAIResponsesInputContent[], text: string): void => {
...
const pushTypedTextPart = (content: OpenAIResponsesInputContent[], type: string, text: string): void => {
...
const pushTypedImagePart = (
  ...
  type: string,
  part: OpenAIResponsesInputImage,
): void => {
...
export const agentMessageContent = (
  item: OpenAIResponsesInputAgentMessageItem,
