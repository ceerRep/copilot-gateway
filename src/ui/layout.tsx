...
<head>
  ...
  <style>
    ...
    /* Replace the native dropdown arrow so it does not flip back to a
       browser-default light triangle on dark backgrounds. Sans-serif and a
       roomier right-side gutter keep multi-word option labels from
       crowding the arrow. The explicit padding-left re-asserts the
       horizontal inset because appearance:none drops the browser's
       default text inset on Chromium. */
    select {
      appearance: none;
